...
module.exports = {
    ...
    actionSignin: async (req, res) => {
        try {
            ...
            if (!user) {
                req.flash('alertMessage', 'User yang ada masukan tidak ada');
    ...
    showImageItem: async (req, res) => {
        try {
            ...
            const alertStatus = req.flash('alertStatus');
            const alert = { message: alertMessage, status: alertStatus };
            res.render('admin/item/view_item', { title: 'Staycation | Show Image Item', alert, item, action: 'show image', user: req.session.user });
        } catch (error) {
            req.flash('alertMessage', `${error.message}`);
            req.flash('alertStatus', 'danger');
            res.redirect('/admin/item');
    ...
    showEditItem: async (req, res) => {
        try {
            ...
            const alertStatus = req.flash('alertStatus');
            const alert = { message: alertMessage, status: alertStatus };
            res.render('admin/item/view_item', { title: 'Staycation |Edit Item', alert, item, action: 'edit', category, user: req.session.user });
        } catch (error) {
            req.flash('alertMessage', `${error.message}`);
            req.flash('alertStatus', 'danger');
            res.redirect('/admin/item');
    ...
    addFeature: async (req, res) => {
        ...
        try {
            ...
            item.featureId.push({ _id: features._id })
            await item.save();
